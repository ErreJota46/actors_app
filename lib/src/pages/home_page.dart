...
import 'package:actors_app/src/search/search_delegate.dart';

import 'package:actors_app/src/widgets/card_swiper_widget.dart';
import 'package:actors_app/src/widgets/movie_horizontal.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget _swiperTarjetas() {
    return FutureBuilder<List<Actor>>(
      future: actoresProvider.getEnTendencia(""),
